...
function Login() {
      ...
      signUp(data)
        .then(res => {
          ...
          if (res.data.access_token !== undefined) {
            localStorage.setItem('accessToken', res.data.access_token);
            Swal.fire('가입성공', '회원가입에 성공하셨습니다.', 'success').then(
              res => {
                if (res.isConfirmed) {
                  window.location.reload();
                }
  ...
  return (
    <Container>
      <LoginBox>
        <TitleWrapper>
          {wantSignup ? <Title>Signup</Title> : <Title>Login</Title>}
        </TitleWrapper>
        <FormWrapper>
